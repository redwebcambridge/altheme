...
function is_adult_ed_page() {
  if(get_field('activate_adult_learning','option')) {
    global $post;
    if (is_page_template('page-templates/adult-learning.php') || is_page_template('page-templates/adult-learning-homepage.php') || 'adultlearning' == get_post_type() || is_singular( 'adultlearning' ) || is_tax('adult-learning-category') || $post->post_parent == get_field('adult_learning_homepage','option') || isset($_GET['site_section']) && $_GET['site_section'] == 'adult_ed' ) :
      return true;
    endif;
    if (is_archive()) {
...
function is_sports_page() {
  if(get_field('activate_sport_centre','option')) {
    global $post;
    if (is_page_template('page-templates/sports-centre.php') || is_page_template('page-templates/sports-homepage.php') || 'sportscentre' == get_post_type() || is_singular( 'sportscentre' ) || is_tax('sports-centre-category') || $post->post_parent == get_field('sports_homepage','option') || isset($_GET['site_section']) && $_GET['site_section'] == 'sports' ) :
      return true;
    endif;
    if (is_archive()) {
      $term = get_queried_object();
